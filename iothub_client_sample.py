...
MSGLane4_TXT = "{\"deviceId\": \"myPythonDevice\",\"PinsCCC\": %.2f,\}"
...
def iothub_client_sample_run():
    ...
    try:
        ...
        if client.protocol == IoTHubTransportProvider.MQTT:
            ...
            filename = "imageforblob12ccc.jpg"
        ...
        while True:
            ...
            for message_counter in range(0, MESSAGE_COUNT):
                ...
                msg_txt_formatted = MSGLane4_TXT % (randint(0,1023))
                message = IoTHubMessage((msg_txt_formatted))

                client.send_event_async(message, send_confirmation_callback, message_counter)
                client.upload_blob_async(filenamea,content, len(content), blob_upload_conf_callback,1001)
