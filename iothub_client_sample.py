...
CONNECTION_STRING = credentials.login["ConnectionString"]
...
def prepare_and_upload_image():
    ...
    f = open("/home/pi/Shared/py/setupImage.jpg", "rb")
    content = f.read
    IoTHubClient.upload_blob_async(filename,content, len(content), blob_upload_conf_callback)
    ...
    try:
        ...
        while True:
            ...
            for message_counter in range(0, MESSAGE_COUNT):
                ...
                client.upload_blob_async(filenamea,msg_txt_formatted, len(msg_txt_formatted), blob_upload_conf_callback,1001)
