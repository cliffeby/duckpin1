...
templ = None
mask = None
image_window = 'P:/images/image0e.jpg'
result_window = 'P:/images/onePin.jpg'
...
#       return -1
   ...
   global img
   global templ
   img = cv2.imread('/home/pi/Shared/images/image0e.jpg', cv2.IMREAD_COLOR)
   templ = cv2.imread('/home/pi/Shared/images/onePin.jpg', cv2.IMREAD_COLOR)
